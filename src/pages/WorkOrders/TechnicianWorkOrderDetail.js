...
import { BackIcon, SaveIcon, CheckIcon, ClockIcon, AlertIcon, CloseIcon, CalendarIcon, ImageIcon, DeleteIcon, SearchIcon } from '../../components/icons/SvgIcons';
          ...
          <div className="card">
            ...
            <div className="work-order-details">
              <div className="details-section">
                <h3>Informacije o radnom nalogu</h3>
              ...
              <div className="details-section">
                ...
                <div className="details-grid">
                  ...
                  <div className="detail-item">
                    <label>TIS Posao ID:</label>
                                        <p>{workOrder.tisJobId || 'Nije dostupno'}</p>
                  </div>
                </div>
              </div>
              ...
              {workOrder.details && (
                <div className="details-section">
                  <h3>Detalji instalacije</h3>
                  <p className="details-text">{workOrder.details}</p>
                </div>
              )}
              
              {showPostponeForm && (
                <div className="details-section postpone-section">
                  <h3>Odlaganje termina</h3>
              ...
              <form onSubmit={handleSubmit} className="technician-comments-form">
                <div className="form-group">
                  <label htmlFor="comment">Komentar tehničara:</label>
                  <textarea
                    id="comment"
                    name="comment"
                    ...
                    {images.map((imageUrl, index) => (
                      <div key={index} className="gallery-image-item">
                        <img 
                          ...
                          onClick={() => window.open(`${apiUrl}${imageUrl}`, '_blank')}
                        />
                      </div>
                    ))}
                  </div>
