...
export const financesAPI = {
  ...
  retryAllFailedTransactions: () => api.post('/api/finances/retry-all-failed-transactions'),
  migrateCustomerStatusKeys: () => api.post('/api/finances/migrate-customer-status-keys'),
